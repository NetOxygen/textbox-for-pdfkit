...
function addTextbox(text, doc, posX, posY, width, height, style = {}) {
  ...
  drawTextLinesOnPDF(optimizedLines, width, height, posX, posY, textboxStyle, doc, baseline);
}

// This function takes the prepared Data and draws everything on the right
// position of the PDF

function drawTextLinesOnPDF(lines, width, height, posX, posY, defaultStyle, doc, baseline) {
  let currentHeight = 0;
  let yPosition =
